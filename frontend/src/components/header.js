...
export default function Header() {
  ...
  return (
    <header className='container' style={{ fontSize: "10px", padding: "20px", marginBottom: "200px",marginTop:"50px" }}>
      ...
      <div className="flex-container">
        <div><button  class="btn btn-light oval-btn" >Try Now</button></div>
